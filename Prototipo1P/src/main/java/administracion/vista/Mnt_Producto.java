...
import administracion.modelo.productoDAO;
import java.util.List;

public class Mnt_Producto extends javax.swing.JInternalFrame {
    ...
    private void limpiar() {
        procesosr.limpiarTxf(Txt_id, Txt_nombre, Txt_cant,Txt_busqueda);
    ...
    private void cargarDatos(String query) {
        ProcesosRepetidos procesosr = new ProcesosRepetidos();
        productoDAO.codigoProducto = query;
        productoDAO.nombreProducto = query;
        String encabezado[] = {"ID", "NOMBRE", "CANTIDAD", "ESTADO"};
        ...
        int tamaño[] = {25, 75, 75, 75};
        productoDAO prodDAO = new productoDAO();
        List<producto> listaVehiculos = prodDAO.select();
        for (producto vehiculo : listaVehiculos) {
            datos[0] = vehiculo.getId();
            datos[1] = vehiculo.getNombre();
            datos[2] = vehiculo.getCantidad();
    ...
    private void initComponents() {
        ...
        Rb_ago = new javax.swing.JRadioButton();
        ...
        Lbl_cant.setFont(new java.awt.Font("Ubuntu", 1, 14)); // NOI18N
        Lbl_cant.setForeground(new java.awt.Color(255, 255, 255));
        Lbl_cant.setText("CANTIDAD:");

        Txt_cant.setBackground(new java.awt.Color(163, 177, 138));
        Txt_cant.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        Txt_cant.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 1, 0, new java.awt.Color(88, 129, 87)));

        Lbl_estado.setFont(new java.awt.Font("Ubuntu", 1, 14)); // NOI18N
        Lbl_estado.setForeground(new java.awt.Color(255, 255, 255));
        Lbl_estado.setText("ESTADO:");

        Bg_estados.add(Rb_disp);
        Rb_disp.setText("DISPONIBLE");

        Bg_estados.add(Rb_ago);
        Rb_ago.setText("AGOTADO");
        Rb_ago.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                Rb_agoActionPerformed(evt);
            }
        });
    ...
    private void Tbl_DatosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Tbl_DatosMouseClicked
        if (evt.getClickCount() == 2) {
            ...
            Txt_cant.setText(Tbl_Datos.getValueAt(Tbl_Datos.getSelectedRow(), 2).toString());
            if (Tbl_Datos.getValueAt(Tbl_Datos.getSelectedRow(), 3).toString().equals("Disponible")) {
                Rb_disp.setSelected(true);
            } else {
                Rb_ago.setSelected(true);
            }
        }
    ...
    private void Btn_modificarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Btn_modificarMouseClicked
        if (procesosr.isEmptyTxf(Txt_id, Txt_nombre, Txt_cant)) {
            if (procesosr.isNumeric(Txt_id,Txt_cant)) {
                if (procesosr.isSelectedRbt(Rb_disp, Rb_ago)) {
                        prod.setId(Txt_id.getText());
                        prod.setNombre(Txt_nombre.getText());
                        prod.setCantidad(Txt_cant.getText());
                        if (Rb_disp.isSelected()) {
                            prod.setEstado("1");
                        } else {
                            prod.setEstado("0");
                        }
                        prodDAO.update(prod);
                        cargarDatos("");
                        procesosr.accionExitosa("Modificación Exitosa", "Se ha modificado el producto: \"" + Txt_nombre.getText() + "correctamente");
                        limpiar();
        ...
        if (procesosr.isEmptyTxf(Txt_id)) {
            if (procesosr.isNumeric(Txt_id)) {
                if (procesosr.confirmarEliminación("el Modulo # " + Txt_id.getText())) {
                    ...
                    prodDAO.delete(prod);
                    cargarDatos("");
                    procesosr.accionExitosa("Eliminación Exitosa", "Se ha eliminado el producto #" + Txt_id.getText() + " correctamente");
                    limpiar();
                }
            }
        }
        ...
        if (procesosr.isEmptyTxf(Txt_id, Txt_nombre, Txt_cant)) {
            if (procesosr.isNumeric(Txt_id,Txt_cant)) {
                if (procesosr.isSelectedRbt(Rb_disp, Rb_ago)) {
                        ...
                        prodDAO.insert(prod);
                        cargarDatos("");
                        procesosr.accionExitosa("Registro Exitoso", "Se ha registrado el producto: \"" + Txt_nombre.getText() + "\" correctamente");
                        limpiar();
    ...
    private void Rb_agoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Rb_agoActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_Rb_agoActionPerformed
    ...
    private javax.swing.JRadioButton Rb_ago;
